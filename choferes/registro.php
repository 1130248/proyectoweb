...
$resultado = $mysqli->query($consulta);
	...
	while ($fila = $resultado->fetch_row()) {
		...
		echo "<td>".$fila[0]."</td>
		      ...
		      <td><center>
			  <a href=plantilla-actualizar.php?id_chof=".$fila[0]."><img src=../imagenes/actualizar.png width=35 height=35 /></a><a href=plantilla-actualizar.php?borrar=".$fila[0]."><img src=../imagenes/eliminar1.png width=35 height=35  /></a>
</center></td>";
		echo "</tr>";
